package com.attia.vc.exception;
...
public class ApiExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    public ResponseEntity<ErrorDetails> handleOtherApiException(BadCredentialsException ex, WebRequest request) {
        ErrorDetails errorDetails = buildErrorDetails(ex.getMessage(), request.getDescription(false), HttpStatus.UNAUTHORIZED, HttpStatus.UNAUTHORIZED.getReasonPhrase());
        return new ResponseEntity<>(errorDetails, HttpStatus.UNAUTHORIZED);
    }
    @ExceptionHandler(UsernameNotFoundException.class)
    public ResponseEntity<ErrorDetails> handleOtherApiException(UsernameNotFoundException ex, WebRequest request) {
    ...
    public ResponseEntity<ErrorDetails> handleOtherApiException(AccessDeniedException ex, WebRequest request) {
        ErrorDetails errorDetails = buildErrorDetails(ex.getMessage(), request.getDescription(false), HttpStatus.FORBIDDEN, HttpStatus.FORBIDDEN.getReasonPhrase());
